...
const ICONS: Record<string, () => JSX.Element> = {
  ...
  board: () => (
    <>
      <path d="M9.4 9.2h5.2v11.4H9.4zM3.4 13.4h6v7.2h-6zM14.6 11.4h6v9.2h-6z" />
      <path d="m12 3 1.15 2.36 2.6.38-1.88 1.83.44 2.59L12 8.94l-2.31 1.22.44-2.59L8.25 5.74l2.6-.38z" />
    </>
  ),
  lock: () => (
    <>
