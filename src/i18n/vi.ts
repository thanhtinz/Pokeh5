...
export const vi: Record<string, string> = {
  ...
  'advice.fair': 'Phiên chợ có nấc nhận được rồi',
  ...
  'ledger.title': 'Sổ sách',
  'ledger.run': 'Lượt này',
  'ledger.life': 'Cả đời',
  'ledger.note': 'Cột trái về mốc đầu mỗi lần làm lại. Cột phải thì không bao giờ tụt.',
  'ledger.dayCount': '{days} ngày',
  'ledger.peak': 'Đỉnh lượt này',
  'ledger.income': 'Tự động',
  'ledger.units': 'Suất đang giữ',
  'ledger.managers': 'Quản lý',
  'ledger.upgrades': 'Bậc nâng cấp',
  'ledger.pending': 'Uy tín đang chờ',
  'ledger.best': 'Kỷ lục',
  'ledger.days': 'Đã mở sổ',
  'ledger.runs': 'Số lần làm lại',
  'ledger.reputation': 'Tổng uy tín',
  'ledger.achievements': 'Thành tựu',
  'ledger.taps': 'Lần chạm',
  'ledger.jobs': 'Ca đã làm',
  'ledger.cards': 'Kèo đã bắt',
  'ledger.trades': 'Lệnh đã đặt',
  'ledger.boughtUnits': 'Suất từng mở',
  ...
  'fair.title': 'Phiên chợ',
  'fair.dawn': 'Chợ sớm',
  'fair.hiring': 'Hội chợ việc làm',
  'fair.lucky': 'Phiên hên',
  'fair.opening': 'Phiên khai trương',
  'fair.buff.dawn': 'Chạm ra gấp đôi công',
  'fair.buff.hiring': 'Ca làm trả gấp đôi',
  'fair.buff.lucky': 'Kèo tới dày gấp đôi',
  'fair.buff.opening': 'Mọi nguồn thu ×1,5',
  'fair.goal.dawn': 'Chạm tay',
  'fair.goal.hiring': 'Ca đã làm',
  'fair.goal.lucky': 'Kèo đã bắt',
  'fair.goal.opening': 'Suất đã mở',
  'fair.open': 'Còn {time}',
  'fair.closed': 'Mở sau {time}',
  'fair.next': 'Phiên sau: {name}',
  'fair.tier': 'Nấc {index}/{total}',
  'fair.claim': 'Nhận',
  'fair.maxed': 'Hết thang',
  'fair.shut': 'Chợ đang nghỉ',
  'fair.note': 'Phiên mở một ngày, nghỉ một ngày, mỗi phiên một món khác. Điểm không mang sang phiên sau được.',
  'fair.opened': 'Phiên chợ mở: {name}',
  'fair.finished': 'Leo hết thang · thu nhập ×{multiplier} trong {seconds} giây',
  ...
  'auth.settings': 'Đổi mật khẩu hoặc xoá tài khoản',
  'auth.hideSettings': 'Thu lại',
  'auth.currentPassword': 'Mật khẩu hiện tại',
  'auth.newPassword': 'Mật khẩu mới',
  'auth.changePassword': 'Đổi mật khẩu',
  'auth.passwordChanged': 'Đổi xong. Máy khác đang đăng nhập sẽ bị đăng xuất.',
  'auth.deleteAccount': 'Xoá tài khoản',
  'auth.deleteConfirm': 'Xoá vĩnh viễn tài khoản {name}? Ván chơi, kỷ lục, chỗ trên bảng — mất hết, không lấy lại được.',
  'err.password.wrong': 'Mật khẩu hiện tại không đúng.',
