  ...
  <center>
    ...
    <tr><td></td><td></td>
        ...
        ?>)
                ...
                <img class="animated slideInLeft" id="img_trainer" src="images/<?php  echo $computer_info['map']."/".$computer_info['wild_id']; ?>.gif" style="padding: 20px 0px 0px 50px;max-width: 70%;height:auto;max-height:100px"/></div> 
            </td></tr>
			<tr>
			<td> 
